...
(async function () {
	...
	model = await tf.loadModel('https://dermanis.netlify.app//final_model_kaggle_version1/model.json');
	$("#selected-image").attr("src", "https://dermanis.netlify.app//assets/samplepic.jpg");
