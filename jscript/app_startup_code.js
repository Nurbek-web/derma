...
(async function () {
	...
	model = await tf.loadModel('https://dermaweb.netlify.app//final_model_kaggle_version1/model.json');
	$("#selected-image").attr("src", "https://dermaweb.netlify.app//assets/samplepic.jpg");
